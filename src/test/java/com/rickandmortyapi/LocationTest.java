...
import com.rickandmorty.Location;
...
public class LocationTest {
	...
	public void testGet_withIds5and10() {
		final Location anatomyPark = location.get(5, 10).iterator().next();
	...
	public void testFilter_withEarthPlanet() {
		for (Location location : location.withName("Earth").withType("Planet").filter()) {
