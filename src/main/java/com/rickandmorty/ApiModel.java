...
import com.rickandmorty.util.Jsons;
...
abstract class ApiModel<PK extends Serializable, T extends ApiModel<PK, T>> implements Serializable {
	...
	protected void validateId() {
		if (getId() == null) {
			throw new IllegalArgumentException("El ID de objeto debe establecerse para utilizar este método..");
		}
	}

	protected void validateFilters() {
		if (filters == null || filters.isEmpty()) {
			throw new IllegalArgumentException("No se han definido criterios de filtro.");
		}
	}
